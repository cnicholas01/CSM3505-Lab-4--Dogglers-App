...
@SmallTest
class ListVerticalTest : BaseTest() {

    @get:Rule
    var activityRule: ActivityScenarioRule<ListVerticalActivity>
            = ActivityScenarioRule(ListVerticalActivity::class.java)
...
//reference: google android developer
